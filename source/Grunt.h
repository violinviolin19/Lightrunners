...
class Grunt : public CapsuleObstacle {
private:
    ...
    std::shared_ptr<cugl::scene2::SceneNode> _gruntNode;
...
#pragma mark Static Constructors
     ...
     */
    static std::shared_ptr<Grunt> alloc(const Vec2 pos, const cugl::Size& size, string name) {
