 ...
 */
void WidgetLoader::materialize(const std::string& key,
 ...
 */
bool WidgetLoader::read(const std::string key, const std::string source,
 ...
 * @return true if the asset was successfully loaded
 */
bool WidgetLoader::read(const std::shared_ptr<JsonValue>& json,
                        LoaderCallback callback, bool async) {
