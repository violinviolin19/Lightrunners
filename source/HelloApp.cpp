...
void HelloApp::buildScene() {
  ...
  std::shared_ptr<scene2::Button> button =
      scene2::Button::alloc(scene2::PolygonNode::allocWithTexture(up),
  ...
  button->setPosition(size.width - (bsize.width + rOffset) / 2,
                      (bsize.height + bOffset) / 2);
