...
void LevelGenerator::markAndFillHallways() {
  ...
  segregateLayer(_inside_layer, 0.0f, _config.getInnerCircleRadius());
  segregateLayer(_middle_layer, _config.getInnerCircleRadius(),
                 _config.getMiddleCircleRadius());
  segregateLayer(_outside_layer, _config.getMiddleCircleRadius(),
                 _config.getMapRadius());
