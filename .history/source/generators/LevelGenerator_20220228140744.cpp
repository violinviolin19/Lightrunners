...
void LevelGenerator::placeTerminals() {
  ...
  _inner_rooms.insert(_inner_rooms.end(), inner_terminals.begin(),
                      inner_terminals.end());

  _middle_rooms.insert(_middle_rooms.end(), middle_terminals.begin(),
                       middle_terminals.end());

  _outer_rooms.insert(_outer_rooms.end(), outer_terminals.begin(),
                      outer_terminals.end());
...
void LevelGenerator::markAndFillHallways() {
  ...
  _inner_rooms.insert(_inner_rooms.end(), inside_rooms.begin(),
                      inside_rooms.end());
  ...
  _outer_rooms.insert(_outer_rooms.end(), outside_rooms.begin(),
                      outside_rooms.end());

  calculateDelaunayTriangles(inside_rooms, 0.0f);
  calculateDelaunayTriangles(middle_rooms, _config.getInnerCircleRadius());
  calculateDelaunayTriangles(outside_rooms, _config.getMiddleCircleRadius());

  calculateMinimumSpanningTree(inside_rooms);
  calculateMinimumSpanningTree(middle_rooms);
  calculateMinimumSpanningTree(outside_rooms);
