...
Room LevelGenerator::roomMostOverlappingWith(Room &room) const {
  ...
  auto it = std::max_element(
      _rooms.begin(), _rooms.end(), [](Room const &l, Room const &r) {
        cugl::Size l_size = room_rect.intersect(l.getRect()).size;
        cugl::Size r_size = room_rect.intersect(r.getRect()).size;
